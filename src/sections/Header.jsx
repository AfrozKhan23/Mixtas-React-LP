...
export default function Header() {
  ...
  return (
    <nav
      className="light bg-white w-full flex lg:flex-col flex-row justify-between items-center gap-4
    lg:px-20 px-6 lg:py-1 lg:static sticky top-0 z-[999]"
    >
      <div
        id="top"
      ...
      >
        ...
        >
          ...
          <div className="relative">
            ...
            <div className="bg-black dark:bg-white dark:text-white px-3 py-1 text-white rounded-full absolute -top-[25px] -right-[20px] text-sm">
              2
            </div>
          </div>
        </div>
      ...
      <div
        data-aos="zoom-in"
        id="menus-section"
        className="w-full pb-5 flex lg:justify-center justify-end items-center sticky top-0 left-0 h-fit bg-white dark:bg-white"
      >
