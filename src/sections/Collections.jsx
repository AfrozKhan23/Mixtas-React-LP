...
export default function Collections() {
  ...
  return (
    <section
      id="collections"
      className="light bg-white w-full lg:px-20 px-10 lg:py-20 py-10 flex flex-col justify-center items-center gap-6"
    >
      <h1
        data-aos="zoom-in"
      ...
      >
        <div className="lg:w-[60%] w-full flex flex-col justify-center items-start h-full">
          <div
            className="flex flex-col justify-center items-start gap-4 w-full lg:h-[400px] h-full bg-cover bg-center border-[4px] border-white p-10 cursor-pointer bg-no-repeat"
          ...
          <div className="flex lg:flex-row flex-col w-full h-fit">
            <div
              className="flex flex-col p-6 justify-center items-end gap-4  lg:w-[50%] w-full border-[4px] border-white bg-cover bg-center cursor-pointer col bg-no-repeat lg:h-[400px] h-fit"
        ...
        <div
          className="lg:w-[40%] w-full flex flex-col justify-start items-start gap-4 p-10 bg-cover bg-center lg:h-[805px] h-full border-[4px] border-white cursor-pointer bg-no-repeat"
