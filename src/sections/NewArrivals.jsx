...
export default function NewArrivals() {
  ...
  return (
    <section className="light bg-slate-200 w-full lg:px-20 px-10 lg:py-20 py-10 flex flex-col justify-center items-center gap-6">
      <h1
        data-aos="zoom-in"
      ...
      <h1
        data-aos="zoom-in"
        className="uppercase text-5xl font-bold text-black dark:text-white text-center"
      >
        New Arrivals
      </h1>
      <div
        ...
        {newarrivals.map((item, index) => (
          ...
          >
            ...
            <div className="flex flex-col justify-center items-start gap-3 p-4">
              ...
              <h1 className="text-red-600 dark:text-white text-2xl font-bold">
                {item.price}
              </h1>
            </div>
          </div>
