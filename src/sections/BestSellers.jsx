...
export default function BestSellers() {
  ...
  return (
    <section
      id="products"
      className=" light bg-slate-200 w-full lg:px-20 px-10 lg:py-20 py-10  flex flex-col justify-center items-center gap-6"
    >
      <h1
        data-aos="zoom-in"
          ...
          {bestsellers.map((item, index) => (
            ...
            >
              <div id="image-box" className="relative cursor-pointer">
                ...
                >
                  <div
                    className="bg-white p-3 rounded-full hover:bg-black hover:text-white transform hover:scale-110 transition-transform
                duration-300"
                  >
                    <FaRegHeart />
                  </div>
              ...
              <div className="flex flex-col justify-center items-start gap-3 p-3">
                ...
                <button
                  className="bg-black font-bold dark:bg-white dark:text-black text-sm text-white px-5 py-5 rounded-md transform
                hover:scale-105 transition-transform duration-300 mt-2"
                >
                  Add to Cart
                </button>
              </div>
